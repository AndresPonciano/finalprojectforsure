...
const Pagination = ({totalCount, offset, handlePaginationChange}) => {
    ...
    function PageNums(props) {
        ...
        if(hasNextPage) { 
            ...
            nextElem = <div className="flex items-center h-8"><a onClick={() => handlePaginationChange(nextPage)} className="bg-gray-100 h-full px-2 py-1 flex items-center border border-blue-500 border-black rounded-r hover:bg-blue-200">
                {/* next */}
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
